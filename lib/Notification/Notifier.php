...
class Notifier implements INotifier {
	...
	public function getName(): string {
		return $this->factory->get('nmc-firstrunwizard')->t('First run wizard');
	}
	...
	public function prepare(INotification $notification, string $languageCode): INotification {
		if ($notification->getApp() !== 'nmc-firstrunwizard') {
			// Not my app => throw
	...
	protected function getSubject(INotification $notification, string $languageCode): string {
		$l = $this->factory->get('nmc-firstrunwizard', $languageCode);
	...
	protected function setAppHintDetails(INotification $notification, $languageCode, $app) {
		...
		$notification
			...
			->setIcon($this->url->getAbsoluteURL($this->url->imagePath('nmc-firstrunwizard', 'apps/'. $app . '.svg')));
		return $notification;
	}
